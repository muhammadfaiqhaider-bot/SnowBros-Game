...
private:
    ...
    void handlePlayerPlatformCollision(Player* p)
    {
        ...
        sf::RectangleShape* plats = levels[currentLevelNumber - 1]->getPlatforms();// place platfprmss in levels
        int count = levels[currentLevelNumber - 1]->getPlatformCount();// number of lbls in particular level.....
